...
export const initialArticles: IArticle[] = [
  {
    ...
    position: 1,
    quantity: 1,
    image: `${PUBLIC_URL}/images/01.png`,
    price: 500,
    description:
  ...
  },
  {
    ...
    position: 2,
    quantity: 1,
    image: `${PUBLIC_URL}/images/02.png`,
    price: 750,
